...
db_params['user'] = input('Please Enter DB_User:')
db_params['password'] = input('Please Enter DB_PW:')
...
#filepath = "D:/tt_video_data"


video_data = datacollector(filepath, 'MCI', True)
